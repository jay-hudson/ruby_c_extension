...
srcdir = .
topdir = /usr/local/Cellar/ruby/2.1.5/include/ruby-2.1.0
hdrdir = $(topdir)
arch_hdrdir = /usr/local/Cellar/ruby/2.1.5/include/ruby-2.1.0/x86_64-darwin10.0
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/usr/local/Cellar/ruby/2.1.5
